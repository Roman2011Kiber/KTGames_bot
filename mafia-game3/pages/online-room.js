...
export function OnlineRoomPage(container, { code }) {
  ...
  function onSurrender() {
    ...
    openModal(h('div', {}, [
      ...
      h('p.muted.mb-4', {}, t('room.leave.desc')),
  ...
  function showGone() {
    destroyChat();
    mount(container, Shell({ title: t('room.title'), back: '/online', children: [
      h('div.card.text-center', {}, [
        ...
        h('a.btn.btn-ghost-gold', { href: '#/online', style: 'display:inline-block;width:auto;padding:10px 24px;margin-top:20px' }, t('room.closed.back')),
      ]),
    ] }));
  }
      ...
      openModal(h('div', {}, [
        ...
        h('select.input', { onchange: e => (s.bots = Number(e.target.value)) },
          [0,1,2,3,4,5,6].map(n => h('option', { value: n, selected: n === s.bots },
            n === 0 ? t('room.settings.noBots') : `${n} bot${n===1?'':'s'}`))),
  ...
  function renderResult() {
    ...
    mount(container, Shell({ title: t('room.final'), back: '/online', children: [
